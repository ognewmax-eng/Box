...
У каждого **раунда** можно задать **режим таймера**: `timerStart: "auto"` — таймер стартует сразу при показе вопроса; `timerStart: "manual"` — таймер запускает ведущий кнопкой «Старт таймера».
